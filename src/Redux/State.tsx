...
let store = {
    ...
    addMessageFromDialogs (value: string, self: boolean){
        const newMessage = {
    ...
    addPostFromProfile (value: string)  {
        const newPost = {
            profileSelfPhotoImgUrl: selfPhoto,
    ...
    textAreaFromPostChanger (item: string) {
        this._state.profileWrapperObj.currentInputPost = item
        this.subscribe(this._state)
    },
    textAreaFromDialogsChanger (item: string) {
