...
import {WrapperProfileHeader} from "./ProfileHeader/WrapperProfileHeader";
...
export const  ProfileWrapper:React.FC<ProfileWrapperPropsType> = React.memo((props) => {
    return <div className={s.profileContent}>
        <WrapperProfileHeader isOpenMenu={props.isOpenMenu} openSet={props.openSet} saveNewProfile={props.saveNewProfile} savePhotoTC={props.savePhoto} isOwner={props.isOwner} profileWrapperObj={props.profileWrapperObj}/>
